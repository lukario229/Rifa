...
# 2. FUNCIONES CON CACHÉ (Para mayor velocidad)
...
<div class="info-box">
    ...
    1. <b>Realiza tu transferencia:</b> Usa los datos de arriba.<br><br>
    2. <b>Concepto de pago:</b> Es vital que pongas tu <b>nombre completo</b> como concepto.<br><br>
    3. <b>Confirma tu registro:</b> Llena el formulario de abajo para generar tu número.<br><br>
    4. <b>Envía tu comprobante:</b> Manda captura al contacto para activar tu boleto.
    </p>
</div>
""", unsafe_allow_html=True)
            ...
            if nombre_input and len(tel_input) == 10:
                with st.spinner("Sincronizando..."):
                    ...
                    if guardar_en_nube(nombre_input, tel_input, num):
                        ...
                        st.cache_data.clear() # Limpiar caché para actualizar lista
                        st.rerun()
                    else:
                        st.error("❌ Error de conexión con la base de datos.")
            else:
                st.warning("⚠️ Por favor, ingresa tu nombre y un teléfono válido.")
